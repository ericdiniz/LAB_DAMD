...
Os alunos devem evoluir o aplicativo "Task Manager" (ou adaptar para "Lista de Compras") para suportar operação completa sem internet, garantindo que dados criados ou editados offline sejam sincronizados automaticamente quando a conexão retorna
